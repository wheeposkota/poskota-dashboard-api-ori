            ...
            <div class="m-portlet m-portlet--tab">
                ...
                <div class="m-portlet__body">
                    ...
                    @can('create-epaper')
                        <div class="row mb-4">
                            <div class="col-md-5">
                                <a href="{{route('epaper-package.resource.create')}}" class="btn btn-brand m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air">
                                    <span>
                    ...
                    <!--begin: Datatable -->
                    <table class="table table-striped display responsive nowrap data-table-ajax" id="data-gallery" data-ajax="{{route('epaper-package.resource.service-master')}}" width="100%">
                        <thead>
                            <tr>
