...
<div class="row">
    <div class="col-sm-12">
        ...
        <form class="m-form m-form--fit m-form--label-align-right" action="{{action('\Modules\Gallery\Http\Controllers\PhotoController@store')}}" method="post" enctype="multipart/form-data">
            <!--begin::Portlet-->
            <div class="row">
                <div class="col-md-8">
                        ...
                        <!--begin::Form-->
                            <div class="m-portlet__body">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#" data-target="#photo">Photo</a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="form-group m-form__group d-flex">
                                                <div class="col">
                                                    <div v-for="(item, index) in (components)">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="input-group">
                                                                   <span class="input-group-btn">
                                                                     <a v-bind:data-input="'input-photo-'+(index)" v-bind:data-preview="'image-photo-'+(index)" class="btn btn-file btn-accent m-btn m-btn--air m-btn--custom lfm-input">
                                                                       <i class="fa fa-picture-o"></i> Choose
                                                                     </a>
                                                                   </span>
                                                                   <input v-bind:id="'input-photo-'+(index)" class="form-control file-input" v-bind:data-index="index" v-bind:data-name="'photo'" type="text" v-bind:name="'gallery[gallery_source]['+(index)+'][photo]'" v-model="components[index]['photo']" required readonly>
                                                                </div>
                                                        ...
                                                        <div class="d-flex my-1">
                                                            <div class="col-md-10">
                                                                <textarea v-bind:name="'gallery[gallery_source]['+(index)+'][caption]'" v-model="components[index]['caption']" class="form-control" placeholder="Add A Caption For Image"></textarea>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                    </div>
