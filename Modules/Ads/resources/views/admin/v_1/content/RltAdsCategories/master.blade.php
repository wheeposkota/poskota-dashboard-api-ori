        ...
        <div class="m-portlet m-portlet--tab">
            ...
            <div class="m-portlet__body">
                ...
                @can('create-master-ads')
                    <div class="row mb-4">
                        <div class="col-md-5">
                            <a href="{{action('\Modules\Ads\Http\Controllers\RltAdsCategoriesController@create')}}" class="btn btn-brand m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air">
                                <span>
                ...
                <!--begin: Datatable -->
                <table class="table table-striped responsive data-table-ajax" data-ajax="{{action('\Modules\Ads\Http\Controllers\RltAdsCategoriesController@serviceMaster')}}" id="data-term" width="100%">
                    <thead>
                        <tr>
                            <th data-priority="1">ID</th>
                            <th data-priority="3">Categoy</th>
