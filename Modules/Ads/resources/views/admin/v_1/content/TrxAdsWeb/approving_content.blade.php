            ...
            <div class="m-portlet  m-portlet--tab">
                ...
                <div class="m-wizard m-wizard--success" id="m_wizard">
                    ...
                    <div class="m-wizard__form">
                        <form class="m-form m-form--label-align-left- m-form--state-" id="m_form" action="{{action('\Modules\Ads\Http\Controllers\TrxAdsWebController@approvingContent')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group d-md-flex">
                                                    ...
                                                    <div class="col">
                                                        <input class="form-control" type="text" value="{{$trx_ad_web->ads_title}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group d-md-flex">
                                                    <div class="col-md-4 d-md-flex justify-content-end py-3">
                                                        <label for="exampleInputEmail1">Ads Position :</label>
                                                    </div>
                                                    <div class="col">
                                                        <select class="form-control  m-input select2" readonly>
                                                            ...
                                                            @foreach ($mst_ads_position as $mst_ad_position)
                                                                @if(old('mst_ads_position_id'))
                                                                    <option value="{{$mst_ad_position->getKey()}}" {{old('mst_ads_position_id') == $mst_ad_position->getKey() ? 'selected' : ''}} disabled>{{$mst_ad_position->ads_position}} -- Rp. {{number_format($mst_ad_position->price)}}</option>
                                                                @else
                                                                    <option value="{{$mst_ad_position->getKey()}}" {{!empty($trx_ad_web) && $trx_ad_web->mst_ads_position_id == $mst_ad_position->getKey() ? 'selected' : ''}} disabled>{{$mst_ad_position->ads_position}} -- Rp. {{number_format($mst_ad_position->price)}}</option>
                                                                @endif
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group m-form__group d-md-flex">
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group input-append date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="{{!empty($trx_ad_web) ? \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $trx_ad_web->trx_ad_publish_date)->format('Y-m-d') : \Carbon\Carbon::now()->addDays(1)->format('Y-m-d')}}">
                                                ...
                                                <div class="form-group m-form__group d-md-flex">
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group input-append date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="{{!empty($trx_ad_web) ? \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $trx_ad_web->trx_ad_end_date)->format('Y-m-d') : \Carbon\Carbon::now()->addDays(1)->format('Y-m-d')}}">
                                                            <span class="input-group-addon add-on"><i class="glyphicon glyphicon-calendar"></i></span>
                                                        ...
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                @if(!empty($trx_ad_web) && $trx_ad_web->path_ads != null)
                                                                    <img src="{{generate_storage_url($trx_ad_web->path_ads)}}" alt=""> 
                                                                @else
                                                ...
                                                <div class="form-group m-form__group d-md-flex">
                                                    <div class="col-md-4 d-md-flex justify-content-end py-3">
                                                        <label for="exampleInputEmail1">URL Action :</label>
                                                    </div>
                                                    <div class="col">
                                                        <input class="form-control" type="text" value="{{$trx_ad_web->ads_action}}" readonly>
                                                    </div>
                                                </div>
                                                {{csrf_field()}}
                                                @if(isset($_GET['code']))
