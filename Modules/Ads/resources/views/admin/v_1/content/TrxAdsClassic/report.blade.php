...
<div class="row">
    <div class="col-sm-12">
        ...
        <!--Begin::Main Portlet-->
                                            ...
                                            <table class="table table-stripped" id="invoice-amount"> 
                                                ...
                                                <tbody>
                                                    <tr  class="item odd" > 
                                                        ...
                                                        <td class="item_l">{{$total_ads}}</td> 
                                                        <td class="item_l">{{sprintf('Rp. %s', number_format($trx_ad_classics->sum('trx_order_total')))}}</td> 
                                                    </tr> 
                                                </tbody>            
                                                <tfoot> 
                                                    <tr > <td colspan="7" style="font-size:0.7em;" ><br>*Total Pembayaran yang Diterima adalah Iklan yang telah Berstatus Lunas Ke Atas<br>Tanggal Cetak : {{\Carbon\Carbon::now()->format('d-m-Y H:i:s')}} - BACKUP</td></tr>
                                                </tfoot> 
                                            </table>
                                            <!-- invoice-amount --> 
                                        </div> 
            ...
            @endif
            @foreach ($trx_ad_classics as $tmp_trx_ad_classics)
                <div class="m-portlet  m-portlet--tab">

                    <div class="m-portlet__body">

                        <div class="row justify-content-center">
                                @include('ads::admin.'.$theme_cms->value.'.partials.invoice_ads_classic', ['trx_ad_classics' => $tmp_trx_ad_classics->trxOrder->trxAdClassics])
                        </div>
